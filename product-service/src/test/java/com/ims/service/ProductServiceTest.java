...
//        );
//
//        when(productRepository.findAllByName("Laptop", PageRequest.of(page, size))).thenReturn(products);
//
//        // When
...
//        // Given
//        when(productRepository.findAllByName("Tablet", PageRequest.of(page, size))).thenReturn(List.of());
//
//        // Then
